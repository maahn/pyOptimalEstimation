...
Retrieve N0 and lambda of the drop size distribution N(D) = N0 * exp(-lambda*D) given a refletivity measurement and prior knowledge about N0 and lambda. Rayleigh scattering is assumed.
...
oe = pyOE.optimalEstimation(x_vars, x_ap, x_cov, y_vars, y_cov, y_obs, forward,forwardKwArgs=forwardKwArgs)
